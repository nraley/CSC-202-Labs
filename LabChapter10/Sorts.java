...
public class Sorts
{
    ...
    public static void main(String[] args)
    {
        ...
        resetCounts();  //reset counters to ready for new method call
...
//10.1  a.  We can create a variable "count" and increment it every time a method that calls swap() is called.
//      b.
//
//
//
